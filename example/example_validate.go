...
var github_com_seeruk_valley_validation_constraints_RegexpString_Example_24 = regexp.MustCompile("^Hello")
...
func (e Example) Validate(path *valley.Path) []valley.ConstraintViolation {
	...
	if !github_com_seeruk_valley_validation_constraints_RegexpString_Example_24.MatchString(e.Text) {
		size := path.Write("Text")
		violations = append(violations, valley.ConstraintViolation{
			Field:   path.String(),
			Message: "value must match regular expression",
			Details: map[string]interface{}{
				"regexp": github_com_seeruk_valley_validation_constraints_RegexpString_Example_24.String(),
			},
		})
		path.TruncateRight(size)
	}
